...
var config = {
    msgurl: '/demo/mailbox.do?msg=',///tpl/default/demo/mailbox.html?msg=
    chatlogurl: '/demo/mailbox.do?user=',///resources/js/demo/mailbox.html?user=
    aniTime: 200,
    right: -232,
    api: {
        friend: '/resources/js/plugins/layer/layim/data/friend.json', //好友列表接口
        group: '/resources/js/plugins/layer/layim/data/group.json', //群组列表接口 
        chatlog: '/resources/js/plugins/layer/layim/data/chatlog.json', //聊天记录接口
        groups: '/resources/js/plugins/layer/layim/data/groups.json', //群组成员接口
        sendurl: '' //发送消息接口
    },
    user: { //当前用户信息
        name: '游客',
...
//渲染骨架
xxim.view = (function(){
    var xximNode = xxim.layimNode = $('<div id="xximmm" class="xxim_main" style="right: -232px;">'
            ...
            +'</div>'
            +'<ul class="xxim_bottom" id="xxim_bottom" style="margin-left: -232px;">'
