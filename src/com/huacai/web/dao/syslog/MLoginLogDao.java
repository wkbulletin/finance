...
@Repository("mLoginLogDao")
@Configurable(preConstruction=true)
public class MLoginLogDao{
	private static final Logger log=LogManager.getLogger(MLoginLogDao.class);
	...
	public JSONObject getLogList(int pageSize, int curPage, JSONObject queryData) {
		String sql = "SELECT * FROM BOSS_LOGS_LOGIN WHERE 1=1 ";
